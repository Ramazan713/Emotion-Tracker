...
abstract class $HistoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String emotion, DateTime dateTime});
}
...
class _$HistoryImpl with DiagnosticableTreeMixin implements _History {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'History(id: $id, emotion: $emotion, dateTime: $dateTime)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, emotion, dateTime);
